...
import { ResearchTopicService } from 'src/app/core/services/research-topic.service';
...
export class ResearchTopicComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.route.queryParams.subscribe((params) => {
            ...
            this.getResearchTopic(request);
        });
    }

    public getResearchTopic(request: any): any {
        this.researchTopicService
            .getPaging(request)
    ...
    public selectAllclasss(event: any): void {
        if (event.target.checked) {
            this.selectedclass = this.ResearchTopics.map(
